...
namespace DBM
{
    public partial class smL : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand regch = new SqlCommand("smrl", conn);
            ...
            {
                Session["smuser"]= username;
                Response.Redirect("smVIEW.aspx");
            }
            else
            {
                Response.Write("either you are not a manager or you entered invalid data");
            }
        }
    }
}